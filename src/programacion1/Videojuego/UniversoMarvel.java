...
public class UniversoMarvel extends javax.swing.JFrame {
  ...
  boolean mododejuego_Tutorial=true;
    public UniversoMarvel(ArrayList<Usuario> AtributListadeUsuarios, ArrayList<Loggs> AtributListadeLoggs, String nombreusuario,boolean mododejuego) {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 220, 190, 50));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 320, 190, 50));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/programacion1/Videojuego/Imagenes/Configuracion/ranking (1) (1).png"))); // NOI18N
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        //aquiiii
        MenuPrincipal mp1 = new MenuPrincipal(ListadeUsuarios,ListadeLoggs, GbUsuario,mododejuego_Tutorial);
        mp1.setVisible(true);
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        Rankings rk=new Rankings(ListadeUsuarios,ListadeLoggs, GbUsuario,mododejuego_Tutorial);
        rk.setVisible(true);
        this.setVisible(false);
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        ...
        Batallas bt=new Batallas(this.ListadeUsuarios,this.ListadeLoggs, GbUsuario,mododejuego_Tutorial);
        bt.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UniversoMarvel(null, null,null,true).setVisible(true);
            }
        });
    }
